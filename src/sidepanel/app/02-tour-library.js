        ...
        .map((e) => {
          ...
          return (
            (r = t
              ? ""
              : e.tag
                ? `\n                <div class="library-item-tag">\n                    <span class="tag-pill" data-lib-tag-id="${se(e.id)}">\n                        @${se(e.tag)}\n                        <button class="tag-remove" data-tag-remove="${se(e.id)}" title="Remove tag">✕</button>\n                    </span>\n                </div>\n            `
                : `\n                <div class="library-item-tag">\n                    <button class="tag-add-btn" data-tag-add="${se(e.id)}" title="Add tag for auto-mapping">+ Tag</button>\n                    <div class="tag-input-wrapper" data-tag-input-wrapper="${se(e.id)}" style="display:none">\n                        <input type="text" class="tag-input-field" data-tag-input="${se(e.id)}"\n                            placeholder="tag name" maxlength="20" spellcheck="false">\n                    </div>\n                </div>\n            `),
            `\n            <div class="library-item ${t ? "uploading" : ""}" data-lib-id="${se(e.id)}">\n                <div class="library-item-overlay">\n                    <div class="uploading-spinner"></div>\n                </div>\n                <img class="library-item-img" src="${TFHtmlSafety.safeMediaUrl(e.thumbnail)}" alt="${se(e.fileName)}" loading="lazy">\n                <div class="library-item-info">\n                    <span class="library-item-name" title="${se(e.fileName)}">${se(a)}</span>\n                    ${t ? "" : `\n                        <button class="library-item-delete" data-lib-delete="${se(e.id)}" title="Remove">\n                            <span class="material-symbols-outlined">close</span>\n                        </button>\n                    `}\n                </div>\n                ${r}\n                <div class="library-item-mediaid">${se(n)}</div>\n            </div>\n        `
          );
        })
        .join("") +
